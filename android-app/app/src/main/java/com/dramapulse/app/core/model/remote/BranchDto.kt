...
data class BranchOptionDto(
    ...
    val resultType: String = "image_story",
    val resultContentPath: String = "",
    val coverPath: String = "",
    val generatedPayloadPath: String = "",
    val generatedAt: String = "",
    val resultHook: String = "",
    val resultStory: String = "",
    val storyboardJson: String = "[]",
    val storyboardImagesJson: String = "[]",
    val storyboardManifestJson: String = "{}",
    val narrationPayloadJson: String = "{}",
    val referenceAssetsJson: String = "{}",
...
data class BranchTaskDto(
    ...
    val storyContextJson: String = "{}",
    val storyContextVersion: String = "",
    val storyContextAssetPath: String = "",
    val tailStateSnapshotJson: String = "{}",
    val characterBibleJson: String = "[]",
    val referenceAssetsJson: String = "{}",
    val storyboardImagesJson: String = "[]",
    val storyboardManifestJson: String = "{}",
    val narrationPayloadJson: String = "{}",
    val imageTaskStatus: String = "",
    val imageTaskPayloadJson: String = "{}",
