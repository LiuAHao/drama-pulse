...
export async function seedDatabase(prisma: PrismaClient) {
  ...
  const hl3 = await prisma.highlight.create({
    data: {
      ...
      type: 'conflict',
      title: '矛盾彻底爆发',
      description: '几方情绪正面冲撞，局面一下子炸开。',
      intensity: 5,
      templateId: 'vote_side',
      interactionOptionsJson: JSON.stringify(['别忍了', '直接开怼']),
      visualEffectType: 'impact_vote_wave',
      source: 'manual',
      confidence: 0.85,
      status: 'confirmed',
    },
  ...
  await prisma.highlight.create({
    data: {
      ...
      type: 'funny',
      title: '嘴硬翻车',
      description: '人物前后反差明显，容易触发观众吐槽和发笑。',
      intensity: 2,
      templateId: 'emotion_button',
      interactionOptionsJson: JSON.stringify(['哈哈']),
      visualEffectType: 'danmaku_float',
      source: 'ai',
      confidence: 0.6,
      status: 'disabled',
    },
  ...
  await prisma.branchOption.create({
    data: {
      ...
      resultContentPath: 'assets/dramas/branches/ep_001_23/bo_001_01/manifest.json',
  ...
  await prisma.branchOption.create({
    data: {
      ...
      resultType: 'image_story',
      resultContentPath: 'assets/dramas/branches/ep_001_23/bo_001_02/manifest.json',
  ...
  await prisma.branchOption.create({
    data: {
      ...
      resultType: 'image_story',
      resultContentPath: 'assets/dramas/branches/ep_002_23/bo_002_01/manifest.json',
  ...
  await prisma.branchOption.create({
    data: {
      ...
      resultType: 'image_story',
      resultContentPath: 'assets/dramas/branches/ep_002_23/bo_002_02/manifest.json',
